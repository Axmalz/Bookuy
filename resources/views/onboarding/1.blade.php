...
<!--
  ...
  Latar belakang putih solid seperti yang diminta.
-->
<div class="w-full h-full bg-white flex flex-col relative">
    ...
    <div class="absolute bottom-0 left-0 w-full z-0">
        <img src="{{ asset('images/onboarding-1.png') }}" alt="Ilustrasi Onboarding" class="w-full object-cover">
    </div>
    ...
    <div class="relative z-10 flex flex-col flex-grow p-6 pt-12">
        ...
        <!-- Bagian Teks Judul -->
        <div class="mt-12">
            <!-- Font 'Sugo' (Oswald) dan ukuran besar -->
            <h1 class="font-sugo text-4xl font-bold text-blue-600 leading-tight">
                ...
                <span class="inline-flex items-baseline">
                    <!-- 1. Gambar Logo 'B' (Menggunakan logo-color-icon.png) -->
        ...
        <!-- 3. Tombol Continue -->
        <!-- DIEDIT: Menghapus font-poppins (diwarisi dari body) -->
        <a href="{{ url('/onboarding/2') }}" class="block w-full bg-blue-600 text-white font-semibold text-lg py-4 px-6 rounded-full text-center shadow-lg shadow-blue-500/50">
            Continue
        </a>
